...
public class Main05 {
    public static void main(String[] args) {
        ...
        ProfundidadDeArbolBinario pdab = new ProfundidadDeArbolBinario(ab);

        int p=2;

        System.out.println("La suma de la profundidad del nivel "+ p +" es: "+ pdab.sumaElementosProfundiad(2));
